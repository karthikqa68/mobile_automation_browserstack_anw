...
public class IOSWebDriverManager {
	...
	public IOSWebDriverManager() {
		...
		if (prop == null) {
			...
			try {
				...
				File directoryPath = new File(System.getProperty("user.dir") + "/src/test/resources/iosproperties");
				// List of all files and directories
				File filesList[] = directoryPath.listFiles();
				for (File file : filesList) {
					FileInputStream propertyfiles = new FileInputStream(
							System.getProperty("user.dir") + "/src/test/resources/iosproperties/" + file.getName());
					prop.load(propertyfiles);
				}
				String env = prop.getProperty("env") + ".properties";
				FileInputStream envpropertyfile = new FileInputStream(
						System.getProperty("user.dir") + "/src/test/resources/iosproperties/" + env);
